...
export class Backend implements backendInterface {
    ...
    async addItemsToCart(arg0: Array<CartItem>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addItemsToCart(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async checkProductExists(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.checkProductExists(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async placeOrder(arg0: Address): Promise<{
        orderId: bigint;
        totalAmount: bigint;
    }> {
        if (this.processError) {
    ...
    async refillCatalog(arg0: Array<Product>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.refillCatalog(to_candid_vec_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "shirts" in value ? Category.shirts : "jeans" in value ? Category.jeans : "tshirts" in value ? Category.tshirts : value;
}
...
function to_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<Product>): Array<_Product> {
